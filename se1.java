...
class Main
{
  ...
  {
  	String[] results = crawledData.split(keyword,100);
  	
  	System.out.println("Found " + results.length + " Search Results");
  	
  	for (int i=0; i < results.length; i++)
  	{
  		//System.out.println("Result #" + i + " : " + results[i].length());
  			System.out.println("\n"+"Result #" + i + " : " + results[i].length() + " length ** " + " : " + results[i]);
  ...
  //getting urls
   public static void getUrlsData(String keyword, String crawledData)
  {
