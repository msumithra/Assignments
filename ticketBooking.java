class main
{
	...
	/*public static boolean isTicketAvailable(int row , int col ,char[][] balcony,char seat)
	{
		//public static char[][] balcony = new char[8][25];
	...
	/*public static String ticketBooking(int price )
	{
		if(price == 300 )
		{
			return "secondClass"; 
	...
	public static boolean bookTicket(int row , int col ,char[][] balcony)
        {
    		String buyTicket = ticketBooking(300);
    		for(int i=0; i < row;i++)
		{
			for(int j =0; j < col; j++)
			{
				if(isTicketAvailable(8, 25 ,balcony,'E'))
				{
					balcony[i][j]='F';
					return true;	
				}
